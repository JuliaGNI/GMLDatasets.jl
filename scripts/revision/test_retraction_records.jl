...
@testset "retraction benchmark failure records" begin
    mktempdir() do directory
        ...
        warmup_base = RetractionRecords.base_record(;
            algorithm = "ScaledSquaring", backend = "CPU",
        ...
        warmup = RetractionRecords.record_invocation(
            warmup_base, () -> reference, () -> nothing,
        ...
        RetractionRecords.write_retraction_records(records_path, [warmup, failure])
